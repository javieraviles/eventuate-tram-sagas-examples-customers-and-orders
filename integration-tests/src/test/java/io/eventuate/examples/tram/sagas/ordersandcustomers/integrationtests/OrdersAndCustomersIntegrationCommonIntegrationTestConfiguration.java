...
@Import({ OrderConfiguration.class, CustomerConfiguration.class, ProductConfiguration.class,
		TramEventsPublisherConfiguration.class, TramCommandProducerConfiguration.class,
...
public class OrdersAndCustomersIntegrationCommonIntegrationTestConfiguration {
	...
	public ChannelMapping channelMapping(TramCommandsAndEventsIntegrationData data) {
		return DefaultChannelMapping.builder().with("CustomerAggregate", data.getAggregateDestination())
				.with("customerService", data.getCommandChannel())
				.with("ProductAggregate", data.getAggregateDestination())
				.with("productService", data.getCommandChannel()).build();
	}
